...
Para saber =)
 ...
 - Utilizei para o desenvolvimento o framework de teste Cucumber e
   linguagem de programação Java. 
 - Optei por deixar a escrita dos testes no Cucumber em pt para
   tornar a formalização do cenário do teste mais fácil e objetiva.
   
 **- Java**
 - Projeto Maven: gerenciamento de todas as
   dependências dinamicamente. 
...
e a automação, poste no github ou bitbucket o código e cenários. Não se esqueça de deixar
